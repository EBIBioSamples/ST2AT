            ...
            if (!sampleSection) {
                ...
                if (headerLine == null) {
                    ...
                    for (int i = 0; i < runlen; i++) {
                                ...
                                if (cAttr != null) {
                                    if (cAttr.getOrder() == i) {
                                        if (!cAttr.getID().equals(parts.get(i)))
                                            throw new STParseException("Attached object redefinition. Line: "
                                                    + reader.getLineNumber() + " Col: " + (i + 1));
                                    } else {
                                        oLst.add(obj = new WellDefinedObject(clsName));
                        ...
                        } else if (Definitions.UNIT.equals(hdr) || Definitions.TERMSOURCEREF.equals(hdr)
                                || Definitions.TERMSOURCEID.equals(hdr)) {
