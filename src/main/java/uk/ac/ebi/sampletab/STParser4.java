  ...
  while((line = reader.readLine()) != null)
  {
   ...
   else
   {
    if(headerLine == null)
    {
     ...
     String h0 = headerLine.get(0);  
       
     if( !h0.equals(Definitions.SAMPLENAME) && !h0.equals(Definitions.GROUPNAME) )
      throw new STParseException("The first column should be " + Definitions.SAMPLENAME +" or " + Definitions.GROUPNAME+ " Line: " + lineNum);
    }
    else
    {
     ...
     for(int i = 0; i < runlen; i++)
     {
      ...
      else if(Definitions.propertyToObject.containsKey(hdr) && group != null)
      {
       ...
       // throw new
       // STParseException("Object redefinition. Line: "+reader.getLineNumber()+" Col: "+(i+1));
