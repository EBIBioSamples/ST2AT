...
#It is stored at git://github.com/EBIBioSamples/ST2AT.git/src/main/bin
#and installed by http://coconut.ebi.ac.uk:8085/browse/BSD-ST2AT
...
$java $args -classpath $classpath uk.ac.ebi.age.STConverter $@
